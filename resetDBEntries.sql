...
INSERT INTO authors(fname, lname, author_bib) VALUES ('Test', 'Author2', 'TEST AUTHOR');
...
INSERT INTO genres (parent, genre_name, genre_description) VALUES (null, 'TestGenre1', 'this genre is all for tests');
INSERT INTO genres (parent, genre_name, genre_description) VALUES (null, 'TestGenre2', 'this genre is all for testing');

--TASK1: create book with no genres tagged
INSERT INTO books (cover_location,cover_name, description, has_identifiers, primary_author_id, publish_date, publisher, series_id, title)
SELECT 'cover/1/2', 'coverImage.jpg', 'This is a test book, it does not exist', false, authors.author_id, null, null, null,'TestBook1'
FROM authors WHERE authors.fname='James' AND authors.lname='Joyce';

--TASK2: create book with a single genre tagged
--1. insert our book into database.
INSERT INTO books (cover_location,cover_name, description, has_identifiers, primary_author_id, publish_date, publisher, series_id, title) SELECT 'cover/1/2','coverImage.jpg','This is a test book, it does not exist',false, authors.author_id, null, null, null,'TestBook2' FROM authors WHERE authors.fname='James' AND authors.lname='Joyce';
--2. add our genre tag to the book_genres table
INSERT INTO book_genres(book_id, genre_name)
SELECT book_id, genres.genre_name FROM books, genres WHERE genres.genre_name='TestGenre1' AND title='TestBook2';

--TASK3: create a book with both genres
--1. insert our book into database.
INSERT INTO books (cover_location,cover_name, description, has_identifiers, primary_author_id, publish_date, publisher, series_id, title)
SELECT 'cover/1/2','coverImage.jpg','This is a test book, it does not exist',false, authors.author_id, null, null, null,'TestBook3'
FROM authors WHERE authors.fname='James' AND authors.lname='Joyce';
--2. add our genre tag to the book_genres table
INSERT INTO book_genres(book_id, genre_name)
...
SELECT 2, 'cover/1/2','coverImage.jpg','This is a test book, it does not exist',false, authors.author_id, null, null, null,'TestBook4'
FROM authors WHERE authors.fname='James' AND authors.lname='Joyce';
